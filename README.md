...
CM146: The dataset is adapted from the UCI Machine Learning Repository and it contains descriptions of hypothetical samples corresponding to 23 species of gilled mushrooms. Each mushroom is described in terms of physical characteristics, and the goal is to classify mushrooms as edible or poisonous.

C147/247A: The CIFAR-10 dataset is a foundational, widely used computer vision resource consisting of 60,000 color images (\(32\times 32\) pixels) divided into 10 distinct classes (e.g., planes, cars, birds, cats, dogs). It is split into 50,000 training images and 10,000 testing images, often used for benchmarking machine learning algorithms and deep neural networks. 
